                           ...
                           implements Deque<E>, Cloneable, Serializable
{
     ...
     * @throws NullPointerException if the specified element is null
     */
    public void addLast(@GuardSatisfied @UnknownInitialization ArrayDeque<E> this, E e) {
        if (e == null)
            throw new NullPointerException();
        final Object[] es = elements;
        es[tail] = e;
     ...
     */
    public boolean addAll(@GuardSatisfied ArrayDeque<E> this, Collection<? extends E> c) {
        final int s, needed;
